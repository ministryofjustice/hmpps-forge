import { Self, Answer, Condition, Transformer, validation, submit, redirect, step } from '@ministryofjustice/hmpps-forge/core/authoring'
import { GovUKRadioInput, GovUKTextInput, GovUKButton, GovUKUtilityClasses } from '@ministryofjustice/hmpps-forge/govuk-components'
...
const heardFromField = GovUKRadioInput({
  code: 'heardFrom',
  fieldset: {
    legend: {
...
export const heardFromStep = step({
  code: 'heard-from',
  path: '/heard-from',
