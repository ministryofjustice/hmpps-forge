import { Answer, Condition, match, and, not, step } from '@ministryofjustice/hmpps-forge/core/authoring'
import {
  GovUKHeading,
  GovUKTaskList,
  GovUKBody,
...
const statusTag = (code: string) =>
  match(Answer(code))
    .case('completed', completedTag)
    .case('in-progress', inProgressTag)
