...
function defineFunctionSet<
  ...
  Evals extends Record<string, (ctxOrValue: CtxOrValue, ...args: any[]) => any>,
...
export function defineConditions<
  E extends Record<string, (value: unknown, ...args: any[]) => boolean | Promise<boolean>>,
>(evaluators: E) {
  const { functions, registry } = defineFunctionSet<unknown, FunctionType.CONDITION, E>(
...
export function defineConditionsWithDeps<D>() {
  return <Fns extends Record<string, (deps: D) => (value: unknown, ...args: any[]) => boolean | Promise<boolean>>>(
    factories: Fns,
  ) => {
...
export function defineTransformers<
  E extends Record<string, (value: unknown, ...args: any[]) => ValueExpr | Promise<ValueExpr>>,
>(evaluators: E) {
  const { functions, registry } = defineFunctionSet<unknown, FunctionType.TRANSFORMER, E>(
...
export function defineTransformersWithDeps<D>() {
  return <Fns extends Record<string, (deps: D) => (value: unknown, ...args: any[]) => ValueExpr | Promise<ValueExpr>>>(
    factories: Fns,
  ) => {
