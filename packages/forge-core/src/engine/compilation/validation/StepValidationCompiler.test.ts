...
import { FunctionASTNode, IterateASTNode, ReferenceASTNode, ValidationASTNode } from '../../types/expressions.type'
...
function createFieldBlock(code: string): FieldBlockASTNode {
...
describe('StepValidationCompiler', () => {
  ...
  beforeEach(() => {
    ...
    compiler = new StepValidationCompiler()
  })
  ...
  describe('compile()', () => {
    it('should keep compiled validation synchronous when registry functions are sync', () => {
      ...
      // Act
      const source = compiler.generateSource(step, [block], [], [], functionRegistry)
      const fn = compiler.compile(step, [block], [], [], functionRegistry)
      const result = fn!(
        createCtx({
    ...
    it('should compile a single field with a required validation', () => {
      // Arrange
      const step = createStep()
      const block = createFieldBlock('firstName')
    ...
    it('should pass validation when condition is truthy', () => {
      // Arrange
      const step = createStep()
      const block = createFieldBlock('firstName')
      const ref = createReference(['answers', 'firstName'])
    ...
    it('should compile multiple validations on one field', () => {
      // Arrange
      const step = createStep()
    ...
    it('should skip validations when dependentWhen is false', () => {
      // Arrange
      const step = createStep()
    ...
    it('should run validations when dependentWhen is true', () => {
      // Arrange
      const step = createStep()
      const block = createFieldBlock('conditionalField')
      const ref = createReference(['answers', 'conditionalField'])
    ...
    it('should skip submissionOnly validations when not submitting', () => {
      // Arrange
      const step = createStep()
    ...
    it('should run submissionOnly validations when submitting', () => {
      // Arrange
      const step = createStep()
      const block = createFieldBlock('name')
      const ref = createReference(['answers', 'name'])
  ...
  describe('predicates', () => {
    ...
    it('should compile NOT predicates', () => {
      // Arrange
      const step = createStep()
      const block = createFieldBlock('field')
    ...
    it('should compile XOR predicates', () => {
      // Arrange
      const step = createStep()
      const block = createFieldBlock('field')
    ...
    it('should compile negated TEST predicates', () => {
      // Arrange
      const step = createStep()
      const block = createFieldBlock('field')
      const ref = createReference(['answers', 'field'])
  ...
  describe('references', () => {
    it('should compile nested answer references', () => {
      // Arrange
      const step = createStep()
    ...
    it('should compile Data references', () => {
      ...
      // Act
      const source = compiler.generateSource(step, [block], [])
  ...
  describe('domain validations', () => {
    it('should compile domain validations', () => {
      // Arrange
      const step = createStep()
  ...
  describe('generateSource()', () => {
    it('should produce readable source code', () => {
      ...
      expect(source).toContain('var errors = []')
      expect(source).toContain('ctx.answers["name"]?.current')
      expect(source).toContain('ctx.conditions.get("isRequired")')
  ...
  describe('iterators', () => {
    ...
    it('should compile iterator with static field code and validation', () => {
      // Arrange
      const step = createStep()
    ...
    it('should generate source with iterator loop', () => {
      ...
      // Act
      const source = compiler.generateSource(step, [], [], [iterateNode])

      // Assert
      expect(source).toContain('for (var')
