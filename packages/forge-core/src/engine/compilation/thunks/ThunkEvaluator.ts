import { ASTNode, JourneyInstanceDependencies, NodeId } from '../../types/engine.type'
import { RuntimeOverlayBuilder, ThunkHandler, ThunkInvocationAdapter, ThunkResult } from './types'
...
export default class ThunkEvaluator implements ThunkInvocationAdapter {
  ...
  constructor(
    ...
    this.runtimeHooksFactory = new ThunkRuntimeHooksFactory(
      ...
      journeyInstanceDependencies.functionRegistry,
    )
  }
   ...
   * @param journeyInstanceDependencies - Journey instance runtime dependencies
  ...
  static withRuntimeOverlay(
    ...
    return new ThunkEvaluator(runtimeDeps, journeyInstanceDependencies, overlay)
  }
