...
> {
   ...
   */
  getPostData(): Record<string, string | string[]>

  getPostData(key: string): string | string[] | undefined

  getPostData(key?: string): Record<string, string | string[]> | string | string[] | undefined {
    if (key === undefined) {
