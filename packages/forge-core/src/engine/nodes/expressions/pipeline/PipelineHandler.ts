...
import { PipelineASTNode } from '../../../types/expressions.type'
import {
  ThunkHandler,
...
import { evaluateOperandWithErrorTracking, evaluateWithScope } from '../../../utils/thunkEvaluatorsAsync'
import { evaluateOperandWithErrorTrackingSync, evaluateWithScopeSync } from '../../../utils/thunkEvaluatorsSync'
