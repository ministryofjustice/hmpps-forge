...
export const NumberConditions = {
  ...
  GreaterThan: condition('Number.GreaterThan', {
  ...
  GreaterThanOrEqual: condition('Number.GreaterThanOrEqual', {
    inputSchema: numberSchema,
    argumentsSchema: numberArgsSchema,
    factory: () => (value: number, threshold: number) => value >= threshold,
  }),
  ...
  LessThan: condition('Number.LessThan', {
    inputSchema: numberSchema,
    argumentsSchema: numberArgsSchema,
    factory: () => (value: number, threshold: number) => value < threshold,
  }),
  ...
  LessThanOrEqual: condition('Number.LessThanOrEqual', {
    inputSchema: numberSchema,
    argumentsSchema: numberArgsSchema,
    factory: () => (value: number, threshold: number) => value <= threshold,
  }),
  ...
  Between: condition('Number.Between', {
    inputSchema: numberSchema,
