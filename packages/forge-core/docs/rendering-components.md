...
A component is a registered renderer identified by a `variant` string. When forge encounters a block with `variant: 'html'`, it looks up the `html` component and calls its render function with the evaluated block data.
...
import { CodeBlock } from '@ministryofjustice/hmpps-forge/core/components'
...
import { BlockDefinition, ConditionalString } from '@ministryofjustice/hmpps-forge/core/components'
...
import { BlockDefinition, ConditionalString, EvaluatedBlock } from '@ministryofjustice/hmpps-forge/core/components'
...
```typescript
import { FieldBlockDefinition, ConditionalString, EvaluatedBlock } from '@ministryofjustice/hmpps-forge/core/components'
...
Components must be registered with forge:
