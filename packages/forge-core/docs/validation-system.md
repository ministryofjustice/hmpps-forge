...
Forge uses a declarative validation system where you define conditions that trigger error messages. Validation rules specify *when* an error should appear and *what* message to display.
