...
import { journey, step, access, createForgePackage, Data, Format } from '../../../../src/authoring'
import { ForgeTestHarness } from '../../../../src/testing'
import { ContractEffects, contractFunctionRegistries } from '../../contractHelpers'
import { contractComponents, StaticText } from '../../testComponents'

const MapEffects = {
  Ping: ContractEffects.register('Ping', {
    factory: () => context => {
