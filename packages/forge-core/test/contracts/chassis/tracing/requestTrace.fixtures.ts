import { access, effect, journey, redirect, step, submit, throwError } from '../../../../src/authoring'
...
const ExplodingEffect = effect('TraceExplode', {
  factory: () => () => {
    throw new Error('Access hook exploded')
  },
})

const ExplodingStatusEffect = effect('TraceExplodeStatus', {
  factory: () => () => {
