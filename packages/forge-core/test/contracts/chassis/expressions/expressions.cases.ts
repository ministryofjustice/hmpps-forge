...
export const journeyCases: JourneyContractCase[] = [
  ...
  },
  {
    ...
    tests: [
      ...
      {
        name: 'should retain keyed values when filtering an object input',
        path: '/object-iteration/result',
        session: { data: { scores: { accommodation: { score: 5 }, finances: { score: 3 } } } },
        data: { filteredEntries: [{ '@key': 'accommodation', score: 5 }] },
      },
    ],
  },
  {
    ...
    tests: [
      {
        name: 'should read the parent item in nested iterators',
