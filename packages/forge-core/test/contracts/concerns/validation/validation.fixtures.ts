...
import { ContractConditions, ContractGenerators, ContractTransformers, Effects } from '../../contractHelpers'
...
const ExplodingCondition = ContractConditions.register('Validation.Explodes', {
  factory: () => () => {
...
export const FixedText = ContractGenerators.register('ScopingFixed', {
  factory: () => (text: ResolvableValue) => text,
})
export const MutateState = ContractGenerators.register('ScopingMutateState', {
...
export const IdentityValue = ContractGenerators.register('ScopingIdentity', {
  factory: () => (value: ResolvableValue) => value,
})
export const ArgumentsInOrder = ContractGenerators.register('ScopingArgumentsInOrder', {
...
export const EqualsValue = ContractConditions.register('ScopingEquals', {
  factory: () => (value: ResolvableValue, expected: ResolvableValue) => value === expected,
})
export const LengthBetween = ContractConditions.register('ScopingLengthBetween', {
  factory: () => (value: ResolvableValue, lower: number, upper: number) =>
    String(value).length >= lower && String(value).length <= upper,
})
export const AppendSuffix = ContractTransformers.register('ScopingAppendSuffix', {
