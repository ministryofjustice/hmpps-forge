...
import {
  ContractConditions,
  ContractEffects,
  contractFunctionRegistries,
  Effects,
  type ContractSession,
} from '../../contractHelpers'
import { contractComponents, TextField, StaticText } from '../../testComponents'
...
const HooksEffects = {
  AppendLog: ContractEffects.register('AppendLog', {
    factory: () => (context: EffectFunctionContext, marker: string) => {
  ...
  SetHeader: ContractEffects.register('SetHeader', {
    factory: () => (context, name: string, value: string) => {
      context.setResponseHeader(name, value)
    },
  }),

  SetCookie: ContractEffects.register('SetCookie', {
    factory: () => (context, name: string, value: string) => {
      context.setResponseCookie(name, value)
    },
  }),

  CaptureRequest: ContractEffects.register('CaptureRequest', {
  ...
  DirectSetAnswer: ContractEffects.register('DirectSetAnswer', {
    factory: () => (context, code: string, value: string) => {
      context.setAnswer(code, value)
    },
  }),

  DirectSetData: ContractEffects.register('DirectSetData', {
    factory: () => (context, key: string, value: string) => {
      context.setData(key, value)
    },
  }),

  DirectClearAnswer: ContractEffects.register('DirectClearAnswer', {
    factory: () => (context, code: string) => {
      context.clearAnswer(code)
    },
  }),

  StoreHasAnswer: ContractEffects.register('StoreHasAnswer', {
    factory: () => (context, code: string, dataKey: string) => {
      context.setData(dataKey, context.hasAnswer(code))
    },
  }),

  SetCookieWithOptions: ContractEffects.register('SetCookieWithOptions', {
    factory: () => (context, name: string, value: string) => {
      context.setResponseCookie(name, value, {
        httpOnly: true,
        secure: true,
  ...
  CaptureAnswerIntrospection: ContractEffects.register('CaptureAnswerIntrospection', {
    factory: () => (context, code: string) => {
  ...
  CaptureRequestFull: ContractEffects.register('CaptureRequestFull', {
    factory: () => (context: EffectFunctionContext) => {
      const session = context.getSession() as HooksSession | undefined
  ...
  CaptureAllData: ContractEffects.register('CaptureAllData', {
    factory: () => context => {
      const session = context.getSession() as HooksSession | undefined
  ...
  CaptureFieldsToClear: ContractEffects.register('CaptureFieldsToClear', {
    factory: () => context => {
  ...
  ThrowUnhandled: ContractEffects.register('ThrowUnhandled', {
    factory: () => () => {
      throw accidentalEffectError
    },
  }),

  ThrowHttpError: ContractEffects.register('ThrowHttpError', {
    factory: () => () => {
      throw httpEffectError
    },
  }),

  ThrowNonError: ContractEffects.register('ThrowNonError', {
    factory: () => () => {
  ...
  return new ForgeTestHarness()
    .registerPackage(
      createForgePackage({
        ...
        functions: [...contractFunctionRegistries, unusualNameEffects],
...
const HooksConditions = {
  ...
  HasContent: ContractConditions.register('HasContent', {
