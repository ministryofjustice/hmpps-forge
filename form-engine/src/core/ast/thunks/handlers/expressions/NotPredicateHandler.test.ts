...
import NotPredicateHandler from './NotPredicateHandler'

describe('NotPredicateHandler', () => {
  beforeEach(() => {
  ...
  describe('evaluate()', () => {
    it('should return true for various falsy primitive values (0, "", null, undefined)', async () => {
      ...
      const testCases = falsyValues.map(async value => {
        ...
        const handler = new NotPredicateHandler(notPredicate.id, notPredicate as any)
