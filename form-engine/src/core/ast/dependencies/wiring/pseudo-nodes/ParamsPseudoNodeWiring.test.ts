...
import ParamsPseudoNodeWiring from './ParamsPseudoNodeWiring'

describe('ParamsPseudoNodeWiring', () => {
  let mockWiringContext: jest.Mocked<WiringContext>
  let mockGraph: jest.Mocked<DependencyGraph>
  let wiring: ParamsPseudoNodeWiring
  ...
  beforeEach(() => {
    ...
    wiring = new ParamsPseudoNodeWiring(mockWiringContext)
  })
