...
import QueryPseudoNodeWiring from './QueryPseudoNodeWiring'

describe('QueryPseudoNodeWiring', () => {
  let mockWiringContext: jest.Mocked<WiringContext>
  let mockGraph: jest.Mocked<DependencyGraph>
  let wiring: QueryPseudoNodeWiring
  ...
  beforeEach(() => {
    ...
    wiring = new QueryPseudoNodeWiring(mockWiringContext)
  })
