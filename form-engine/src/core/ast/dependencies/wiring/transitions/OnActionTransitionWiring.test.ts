...
import OnActionTransitionWiring from './OnActionTransitionWiring'

describe('OnActionTransitionWiring', () => {
  let mockWiringContext: jest.Mocked<WiringContext>
  let mockGraph: jest.Mocked<DependencyGraph>
  let wiring: OnActionTransitionWiring
  ...
  beforeEach(() => {
    ...
    wiring = new OnActionTransitionWiring(mockWiringContext)
  })
