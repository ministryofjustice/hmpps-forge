...
describe('XorHandler', () => {
  ...
  describe('evaluate()', () => {
    it('should return true for single truthy primitive value', async () => {
      // Arrange
      const xorPredicate = ASTTestFactory.predicate(PredicateType.XOR, {
    ...
    it('should handle nested XOR predicates correctly', async () => {
      // Arrange
      const innerXor = ASTTestFactory.predicate(PredicateType.XOR)
      const operand1 = ASTTestFactory.predicate(PredicateType.TEST)
      const outerXor = ASTTestFactory.predicate(PredicateType.XOR, {
