...
import { assertString } from '../conditions/asserts'
...
export default {
   ...
   */
  Trim: buildTransformerFunction('trim', (value: any) => {
   ...
   * // Transforms "Hello World" to "HELLO WORLD"
   */
  ToUpperCase: buildTransformerFunction('toUpperCase', (value: any) => {
   ...
   * // Transforms "Hello World" to "hello world"
   */
  ToLowerCase: buildTransformerFunction('toLowerCase', (value: any) => {
   ...
   * // Transforms "hello world" to "Hello world"
   */
  Capitalize: buildTransformerFunction('capitalize', (value: any) => {
   ...
   */
  Substring: buildTransformerFunction('substring', (value: any, start: number, end?: number) => {
   ...
   */
  Replace: buildTransformerFunction('replace', (value: any, searchValue: string, replaceValue: string) => {
   ...
   */
  PadStart: buildTransformerFunction('padStart', (value: any, targetLength: number, padString: string = ' ') => {
   ...
   */
  PadEnd: buildTransformerFunction('padEnd', (value: any, targetLength: number, padString: string = ' ') => {
   ...
   */
  ToInt: buildTransformerFunction('toInt', (value: any, radix: number = 10) => {
   ...
   */
  ToFloat: buildTransformerFunction('toFloat', (value: any) => {
   ...
   */
  ToArray: buildTransformerFunction('toArray', (value: any, separator?: string) => {
   ...
   */
  ToDate: buildTransformerFunction('toDate', (value: any) => {
