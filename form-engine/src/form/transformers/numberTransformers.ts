...
import { assertNumber } from '../conditions/asserts'
...
export default {
   ...
   * // Add(5, 3) returns 8
   */
  Add: buildTransformerFunction('add', (value: any, addend: number) => {
   ...
   */
  Subtract: buildTransformerFunction('subtract', (value: any, subtrahend: number) => {
   ...
   */
  Multiply: buildTransformerFunction('multiply', (value: any, multiplier: number) => {
   ...
   */
  Divide: buildTransformerFunction('divide', (value: any, divisor: number) => {
   ...
   * // Abs(-5) returns 5
   */
  Abs: buildTransformerFunction('abs', (value: any) => {
   ...
   * // Round(4.7) returns 5
   */
  Round: buildTransformerFunction('round', (value: any) => {
   ...
   * // Floor(4.7) returns 4
   */
  Floor: buildTransformerFunction('floor', (value: any) => {
   ...
   * // Ceil(4.2) returns 5
   */
  Ceil: buildTransformerFunction('ceil', (value: any) => {
   ...
   */
  ToFixed: buildTransformerFunction('toFixed', (value: any, decimals: number) => {
   ...
   * // Max(5, 10) returns 10
   */
  Max: buildTransformerFunction('max', (value: any, comparison: number) => {
   ...
   * // Min(5, 10) returns 5
   */
  Min: buildTransformerFunction('min', (value: any, comparison: number) => {
   ...
   * // Power(2, 3) returns 8
   */
  Power: buildTransformerFunction('power', (value: any, exponent: number) => {
   ...
   * // Sqrt(16) returns 4
   */
  Sqrt: buildTransformerFunction('sqrt', (value: any) => {
   ...
   */
  Clamp: buildTransformerFunction('clamp', (value: any, min: number, max: number) => {
